...
class Collect extends Component{
    constructor(props){
        super(props);
        this.state={
            currentList:this.props.collector? this.props.collector.foundList[0]:null,
            listType:FOUND,
            activeList:0,
            showDialog:false,
            willDelList:null
        };
        this.pageCollect =React.createRef();
    }
    componentDidMount(){
    ...
    render(){
        return (
            <div
            className={['page-collect',this.props.showMusicList || this.props.showSingerInfo? 'hide-page-collect' : ''].join(' ')}
            ref = {this.pageCollect}
            >
                <div className="left-nav">
                    <div className="nav-collect-found-list">
                        <p className="title">创建歌单</p>
